namespace eval ::optrace {
  variable script "/home/anula/OneDrive/PRURE/Laboratorium 2/projektLab2/project_1.runs/impl_1/TOP.tcl"
...
set rc [catch {
  ...
  set_param synth.incrementalSynthesisCache ./.Xil/Vivado-888003-anula/incrSyn
  set_param runs.launchOptions { -jobs 4  }
OPTRACE "create in-memory project" START { }
  create_project -in_memory -part xc7a35tcpg236-1
  set_property board_part_repo_paths {/home/anula/.Xilinx/Vivado/2024.2/xhub/board_store/xilinx_board_store} [current_project]
  set_property board_part digilentinc.com:basys3:part0:1.2 [current_project]
  set_property design_mode GateLvl [current_fileset]
  set_param project.singleFileAddWarning.threshold 0
OPTRACE "create in-memory project" END { }
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir {/home/anula/OneDrive/PRURE/Laboratorium 2/projektLab2/project_1.cache/wt} [current_project]
  set_property parent.project_path {/home/anula/OneDrive/PRURE/Laboratorium 2/projektLab2/project_1.xpr} [current_project]
  set_property ip_output_repo {{/home/anula/OneDrive/PRURE/Laboratorium 2/projektLab2/project_1.cache/ip}} [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet {{/home/anula/OneDrive/PRURE/Laboratorium 2/projektLab2/project_1.runs/synth_1/TOP.dcp}}
OPTRACE "read constraints: implementation" START { }
  read_xdc {{/home/anula/OneDrive/PRURE/Laboratorium 2/Basys-3-Master_lab2.xdc}}
