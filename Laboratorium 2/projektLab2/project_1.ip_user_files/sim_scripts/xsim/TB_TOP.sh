...
#
# Script generated by Vivado on Sat Nov 23 00:57:12 CET 2024
...
# script info
echo -e "TB_TOP.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L secureip --snapshot TB_TOP xil_defaultlib.TB_TOP -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/tools/Xilinx/Vivado/2024.2/data/xsim"
  fi
